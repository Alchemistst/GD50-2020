...
gSounds = {
    ...
    ['shiny'] = love.audio.newSource('sounds/shiny.wav'),
    ['boardReset'] = love.audio.newSource('sounds/boardReset.wav')
}

gTextures = {
    ['main'] = love.graphics.newImage('graphics/match3.png'),
    ['background'] = love.graphics.newImage('graphics/background.png'),
    ['gemShine'] = love.graphics.newImage('graphics/gemShine.png')
}
...
gFrames = {
    ...
    ['shineAnimation'] = GenerateQuads(gTextures['gemShine'], 32, 32)
}
